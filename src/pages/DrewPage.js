      ...
      <div className="drew-page">
        ...
        <div className="drew-content">
          <div className="drew-header">
            <h1>Andrew Canepa</h1>
            <h2>September 8, 1991 - July 28, 2025</h2>
          ...
          <div className="drew-tribute">
            <p>
              ...
              had this rare ability to bring joy just by being himself. He was a natural storyteller
              who lifted people up with the way he spoke about them and how fully he showed up in
              their lives.
            </p>
            <p>
            ...
            <p>
              ...
              deeply loved, supported, and guided, and to grow up with the same strong foundation of
              love, respect, and heart that Andrew lived by every day. His love for Kayden was
            ...
            <p>
              ...
              Pasadena, Andrew had a gift for creating incredible meals. It wasn't just because he
              knew food so well. It was because he understood the power of sharing it. Cooking was
              an extension of his love, and his family and friends were lucky to be on the receiving
              end of that gift time and time again.
            </p>
            <p>
              ...
              life he gave so fully to those he loved. He will be missed forever. He will be loved
              always.
            </p>
          </div>
          <div className="tshirt-link">
            <div className="tshirt-image">
              <img src={drew.memoryLogo} alt="Andrew Logo" />
            </div>
            <p>
          ...
          <div className="cookbook">
            <div className="cookbook-image">
              <img
                src="https://m.media-amazon.com/images/I/61kmUCD6-sL._SL1250_.jpg"
                alt="Andrew's Cookbook"
              />
            </div>
            <div className="cookbook-content">
              <h3>Andrew's Cookbook</h3>
              <p>
                Cooking wasn't just something Andrew enjoyed. It was one of the ways he cared for
                the people around him. His family has gathered many of his favorite recipes into
                Cousin Drew's Cookbook, allowing his love for food and bringing people together to
                live on.
              </p>
              <p>
                "Cooking was never just a hobby for Andrew. It was his passion, his language, and
                the way he connected with the people he loved."
              </p>
              <a
                href="https://www.amazon.com/Cousin-Drews-Cookbook-Andrew-Canepa/dp/B0H8HS7142/ref=sr_1_1?sr=8-1"
                target="_blank"
                rel="noopener noreferrer"
              >
                Order
