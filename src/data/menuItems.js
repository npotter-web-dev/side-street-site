...
const lunchItems = [
  {
    ...
    items: [
      ...
      { name: "Tuna Avocado Swiss Melt", price: "13.99", description: "on Grilled Sourdough" },
      {
        name: "Reuben",
        price: "11.99",
      ...
      { name: "Grilled Ham and Cheese", price: "9.99", description: "" },
      { name: "Grilled Cheese", price: "8.99", description: "" },
      { name: "BBQ Tri-Tip", price: "14.99", description: "on a French Roll" },
      { name: "French Dip", price: "14.99", description: "with Au Jus on a French Roll" },
      {
        name: "Beef Philly",
        price: "15.99",
      ...
      { name: "Turkey Sandwich", price: "9.99", description: "" },
      { name: "Ham Sandwich", price: "9.99", description: "" },
      { name: "Roast Beef or Corned Beef", price: "10.99", description: "" },
      { name: "Tuna Salad Sandwich", price: "10.99", description: "" },
      { name: "Chicken Salad Sandwich", price: "10.99", description: "" },
      { name: "Bacon, Lettuce and Tomato", price: "10.99", description: "(add Avocado +$2.95)" },
      {
  ...
  },
  {
    ...
    image: omelettesImg,
    items: [
      { name: "Burger", price: "9.99", description: "(with Cheese +$1.50)" },
      { name: "Ortega Jack Burger", price: "11.99", description: "" },
      { name: "Cheddar Avocado Burger", price: "13.99", description: "" },
      {
      ...
      { name: "California Burger", price: "12.99", description: "Avocado and Sprouts" },
      {
  ...
  },
  {
    ...
    image: omelettesImg,
    items: [
      { name: "Soup of the Day", price: "4.99/$5.99", description: "" },
      { name: "Soup and Garden Salad", price: "8.99", description: "" },
      {
      ...
      { name: "Caesar Salad", price: "10.99", description: "Add Chicken +$2.50" },
      {
        name: "Spinach Salad",
        price: "13.99",
        description:
